...
public class Sql {
    ...
    public Sql addColumn(String column) {
        columns.add(column);
        return this;
    }

    public Sql addTable(String table) {
        tables.add(table);
        return this;
    }
    ...
    public Sql addCondition(String condition, Object... args) {
        boolean add = true;
        for (Object obj : args) {
            if (obj == null) {
                add = false;
    ...
    public Sql addLast(String last, Object... args) {
        boolean add = true;
        for (Object obj : args) {
            if (obj == null) {
                add = false;
